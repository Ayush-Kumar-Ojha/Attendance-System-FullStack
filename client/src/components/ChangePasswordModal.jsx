...
import { LockIcon, X, Loader2Icon } from "lucide-react";
...
const ChangePasswordModal = ({ open, onClose }) => {
    ...
    return (
        <div className='fixed inset-0 z-50 flex items-center justify-center p-4' onClick={onClose}>
            ...
            <div className='relative bg-white rounded-2xl w-full max-w-md animate-fade-in' onClick={(e) => e.stopPropagation()}>
